package com.example.shahir.bookyourmealserver;
...
public class SignIn extends AppCompatActivity {
    ...
    private void signInUser(final String phone, String password) {
        ...
        mDialog.setMessage("Just a second...");
        ...
        users.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.child(localPhone).exists()){
                    ...
                    if(Boolean.parseBoolean(user.getIsStaff())) {  /// Boolean.parseBoolean this equals true,user.getStaffwill return true or flase if IsStaff == true
